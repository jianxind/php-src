...
#if PHP_HAVE_AVX512_VPCLMULQDQ_SUPPORTS && defined(HAVE_FUNC_ATTRIBUTE_TARGET)
#define ZEND_INTRIN_AVX512_VPCLMULQDQ_RESOLVER 1
#endif

#if defined(ZEND_INTRIN_AVX512_VPCLMULQDQ_RESOLVER) && defined(ZEND_INTRIN_HAVE_IFUNC_TARGET)
# define ZEND_INTRIN_AVX512_VPCLMULQDQ_FUNC_PROTO 1
#elif defined(ZEND_INTRIN_AVX512_VPCLMULQDQ_RESOLVER)
# define ZEND_INTRIN_AVX512_VPCLMULQDQ_FUNC_PTR 1
#endif

#ifdef ZEND_INTRIN_AVX512_VPCLMULQDQ_RESOLVER
# ifdef HAVE_FUNC_ATTRIBUTE_TARGET
#  define ZEND_INTRIN_AVX512_VPCLMULQDQ_FUNC_DECL(func) ZEND_API func __attribute__((target("avx512f,avx512cd,avx512vl,avx512dq,avx512bw,pclmul,vpclmulqdq")))
# else
#  define ZEND_INTRIN_AVX512_VPCLMULQDQ_FUNC_DECL(func) func
# endif
#else
# define ZEND_INTRIN_AVX512_VPCLMULQDQ_FUNC_DECL(func)
#endif
